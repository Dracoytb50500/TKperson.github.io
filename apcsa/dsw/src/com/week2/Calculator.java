...
public class Calculator {
    ...
    private void rpnToResult()
    {
        ...
        for(int i = 0; i < this.reverse_polish.size(); i++)
        {
            ...
            if(this.OPERATORS.containsKey(this.reverse_polish.get(i)))
            {
                // get operator
                String operator = this.reverse_polish.get(i);
                ...
                // calculate result
                Double result = this.calculate(operand1, operand2, operator);
            ...
            else
            {
                ...
                calculation.push(Double.parseDouble(this.reverse_polish.get(i)));
            }
        }
